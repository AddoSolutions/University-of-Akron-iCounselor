...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    if ([[segue identifier] isEqualToString:@"showDetail"]) {
        ...
        UAClass *object = [[self fetchedResultsController] objectAtIndexPath:indexPath];
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"UAClass" inManagedObjectContext:self.managedObjectContext];
